...
export default function DashboardPage() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        variants={itemMotion}
        className="relative overflow-hidden rounded-2xl border border-slate-800 bg-[#17251d] p-5 text-slate-100 shadow-sm lg:p-7"
      >
        ...
        />
        <div
          className="pointer-events-none absolute -bottom-24 -left-24 h-80 w-80 rounded-full bg-emerald-500/10 blur-3xl"
          aria-hidden="true"
        />
        ...
        <div className="relative z-10 grid gap-6 lg:grid-cols-[1.1fr,1.4fr] xl:grid-cols-[1fr,1.35fr]">
            ...
            <div className="space-y-2 overflow-y-auto pr-1">
              {eventsLoading ? (
                ...
                <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-800 bg-slate-900/40 p-8 text-center">
                  <CalendarDays className="h-8 w-8 text-slate-600" aria-hidden="true" />
                  ...
                  <Button
                    ...
                    size="sm"
                    variant="outline"
                    className="mt-4 rounded-full border-slate-700 bg-slate-800 text-xs text-white hover:bg-slate-700"
                  >
                    <Link href="/events?new=1">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isSelected
                          ...
                          : "bg-slate-900/70 border-slate-800/80 text-slate-300 hover:bg-slate-800/80 hover:border-slate-700",
                      )}
                    >
                      ...
                      <div className="mt-1 flex items-center justify-between text-xs">
                        ...
                        <span
                          className={cn(
                            "font-medium",
                            isSelected ? "text-white" : "text-primary/90",
                          )}
                        >
                          {ev.participants?.length || 0} confirmados
                        </span>
                      </div>
                    </button>
                  );
          ...
          <div className="flex flex-col justify-between rounded-2xl border border-slate-800 bg-slate-900/60 p-5 backdrop-blur-md lg:p-6">
            {selectedEvent ? (
              <div className="space-y-5">
                {/* Header tag & quick status */}
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="rounded-full border border-emerald-400/30 bg-emerald-500/20 px-3 py-0.5 text-xs font-semibold text-emerald-300">
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div className="rounded-xl border border-slate-800 bg-slate-950/50 p-3">
                    ...
                    <p className="text-[10px] text-slate-400 mt-0.5">Capacidade</p>
                  </div>
                  ...
                  <div className="rounded-xl border border-slate-800 bg-slate-950/50 p-3">
                    ...
                    <p className="text-[10px] text-emerald-400 mt-0.5">Taxa atual</p>
                  </div>
                </div>

                {/* Participants Preview */}
                <div className="flex items-center justify-between rounded-xl border border-slate-800/80 bg-slate-950/30 p-3">
                  <div className="flex items-center gap-3">
                    <div className="flex -space-x-2 overflow-hidden">
                      {selectedEvent.participants && selectedEvent.participants.length > 0 ? (
                        selectedEvent.participants.slice(0, 4).map((p, idx) => (
                          <Avatar key={p.id || idx} className="h-7 w-7 border-2 border-slate-900">
                        ...
                        <div className="h-7 w-7 rounded-full bg-slate-800 flex items-center justify-center text-[10px] text-slate-400">
                          0
                        </div>
                      )}
                    </div>
                  ...
                  <Button asChild variant="ghost" size="sm" className="h-7 text-xs text-emerald-300 hover:text-white hover:bg-slate-800">
                ...
                <div className="flex items-center justify-between gap-3 pt-2">
                  <div className="flex items-center gap-2">
                    <Button
                      ...
                      variant="outline"
                      size="icon"
                      className="rounded-full border-slate-700 bg-slate-800 text-slate-300 hover:bg-slate-700 hover:text-white"
                  ...
                  <Button
                    asChild
                    className="rounded-full bg-white px-6 font-semibold text-slate-900 shadow-lg shadow-white/10 hover:bg-slate-100"
                  >
                    <Link href={`/portal`}>
                ...
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <Progress
                      ...
                      className="h-2.5 rounded-full bg-slate-100 dark:bg-slate-800 [&>div]:bg-amber-500"
                    />
                  </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3 px-6 pb-6">
              {reportError ? (
                ...
                <div className="flex items-start gap-3 rounded-2xl border border-emerald-500/20 bg-emerald-500/10 p-3.5">
                  ...
                  {inactiveMembers > 0 && (
                    <div className="flex items-start gap-3 rounded-2xl border border-amber-500/20 bg-amber-500/10 p-3.5">
                      ...
                      <div className="text-xs">
                        ...
                        <p className="text-amber-700/80 dark:text-amber-300 mt-0.5">
